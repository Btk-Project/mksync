...
void MKSender::send_motion_event(const mks::MouseMotionEvent &event) const
{
    INPUT input          = {0};
...
void MKSender::send_button_event(const mks::MouseButtonEvent &event) const
{
...
void MKSender::send_wheel_event(const mks::MouseWheelEvent &event) const
{
...
void MKSender::send_keyboard_event(const mks::KeyEvent &event) const
{
    INPUT input          = {0};
